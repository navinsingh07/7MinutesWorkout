...
class Constants {
    companion object {
        fun defaultExerciseList(): ArrayList<ExerciseModel> {
            ...
            val abdominalCrush = ExerciseModel(4, "Abdominal Crunch", R.drawable.ic_abdominal_crunch, false, false)
            ...
            val plank =  ExerciseModel(8, "Step-Up onto Chair", R.drawable.ic_plank, false, false)
            exerciseList.add(plank)

            val highKneesRunningInPlace =  ExerciseModel(9, "Plank", R.drawable.ic_high_knees_running_in_place, false, false)
